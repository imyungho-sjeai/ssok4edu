...
SSOK_ShowWorkToolsGui:
    ...
    Gui, SSOKWorkTools:Add, Button, x8 y132 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_CompanyInfo, ±¹¼¼Ã»¡¤Á¶´ÞÃ» ¾÷Ã¼Á¶È¸
    Gui, SSOKWorkTools:Add, Button, x8 y163 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_Privacy, °³ÀÎÁ¤º¸ ¼û±â±â
    Gui, SSOKWorkTools:Add, Button, x8 y194 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_CommaToggle, ¼ýÀÚ Ãµ ´ÜÀ§ Åä±Û
    Gui, SSOKWorkTools:Add, Button, x8 y225 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_SchoolSearch, ÇÐ±³°Ë»ö (Àü±¹)
    Gui, SSOKWorkTools:Add, Button, x8 y256 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_SchoolSearchNational, ÇÐ±³°Ë»ö (¼¼Á¾)
    Gui, SSOKWorkTools:Add, Button, x8 y287 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_LocalFinanceInfo, Áö¹æ±³À°ÀçÁ¤Á¤º¸
    Gui, SSOKWorkTools:Add, Button, x8 y318 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_ContractG2B, °è¾àÇöÈ² (³ª¶óÀåÅÍ)
    Gui, SSOKWorkTools:Add, Button, x8 y349 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_ContractLofin365, °è¾àÇöÈ² (Áö¹æÀçÁ¤365)
    Gui, SSOKWorkTools:Add, Button, x8 y380 w%SSOK_WorkToolsButtonW% h25 gSSOK_WorkTools_ContractSejong, °è¾àÇöÈ² (¼¼Á¾)
    Gui, SSOKWorkTools:Add, Button, x8 y411 w%SSOK_WorkToolsButtonW% h25 vSSOK_WorkTools_Exit gSSOK_Tool_SidebarDeleteProxy, Á¾·á
    Gui, SSOKWorkTools:Add, Button, x8 y442 w%SSOK_WorkToolsButtonW% h25 vSSOK_WorkTools_BetaToggle gSSOK_WorkTools_BetaToggle, Å×½ºÆ®¹öÀü Beta
    Gui, SSOKWorkTools:Add, Button, x8 y504 w%SSOK_WorkToolsButtonW% h25 vSSOK_WorkTools_Win1 gSSOK_Advanced_Win1 Hidden, °£Æí ¿øÀÎÇàÀ§(win+2)
    Gui, SSOKWorkTools:Add, Button, x8 y535 w%SSOK_WorkToolsButtonW% h25 vSSOK_WorkTools_Win2 gSSOK_Advanced_Win2 Hidden, °£Æí ¿øÀÎÇàÀ§(win+4)
    Gui, SSOKWorkTools:Add, Button, x8 y566 w%SSOK_WorkToolsButtonW% h25 vSSOK_WorkTools_ExpenseDraft gSSOK_Advanced_ExpenseDraft Hidden, °£Æí ÁöÃâÇ°ÀÇ(win+1)
...
SSOK_AdminCalendar_ShowPopupColumns(title, seoulEvents, jeonbukEvents)
{
    ...
    ; ¼­¿ï/ÀüºÏ ¸ðµÎ ¿À´Ã ÀÏÁ¤ÀÌ ¾øÀ¸¸é ÆË¾÷À» ¶ç¿ìÁö ¾Ê´Â´Ù.
    ...
    ; Á¦¸ñÀº ±âº» Å©±â, Áö¿ª¸íÀº ÀÛ°í ¿¬ÇÑ È¸»öÀ¸·Î °¢ Ä­ ÁÂÃø »ó´Ü¿¡ Ç¥½Ã
    Gui, SSOKAdminCalPopup:Font, s9 Bold, Malgun Gothic
    Gui, SSOKAdminCalPopup:Add, Text, x20 y16 w740 h24 Center, %title%

    Gui, SSOKAdminCalPopup:Font, s6 Normal c909090, Malgun Gothic
    Gui, SSOKAdminCalPopup:Add, Text, x24 y47 w350 h14 Left, ¼­¿ï
    Gui, SSOKAdminCalPopup:Add, Text, x404 y47 w350 h14 Left, ÀüºÏ

    ; ÀÏÁ¤ º»¹®Àº ³ôÀÌ¸¦ °íÁ¤ÇÏÁö ¾Ê´Â´Ù. ½ÇÁ¦ Ç¥½ÃµÇ´Â ¹®±¸ ¼ö/ÁÙ¹Ù²Þ¿¡ ¸ÂÃç ÀÚµ¿ ³ôÀÌ·Î »ý¼ºÇÑ´Ù.
    ...
    ; °¡¿îµ¥ ±¸ºÐ¼±¸¸ ¾ÆÁÖ ¿¶°Ô Ç¥½ÃÇÏ°í, ¼­¿ï/ÀüºÏ ¾Æ·¡ °¡·Î¼±Àº »ç¿ëÇÏÁö ¾Ê´Â´Ù.
    sepY := 46
    ...
    Gui, SSOKAdminCalPopup:Add, Button, x330 y%buttonY% w120 h30 gSSOK_AdminCalendar_PopupHide, È®ÀÎ

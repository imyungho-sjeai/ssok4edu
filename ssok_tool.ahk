...
SSOK_ShowCalculator:
    ...
    Gui, SSOKCalc:Add, Text, x12 y102 w796 h20 vSSOK_CalcHelp, ¿¹: 5,000 * 2°³ * 4ÁÖ=  ¶Ç´Â  (1,000 + 2,000) * 10
    ...
    Gui, SSOKCalc:Font, s8 bold c333333, Malgun Gothic
    Gui, SSOKCalc:Add, Text, x638 y156 w52 h20 Right vSSOK_CalcRateLabel, ÀÎÁ¤·ü:
    ...
    Gui, SSOKCalc:Add, Button, x12 y242 w550 h30 Default vSSOK_CalcCalculateBtn gSSOK_CalcCalculate, °è»ê (Enter)
    Gui, SSOKCalc:Font, s9 norm, Malgun Gothic
    Gui, SSOKCalc:Add, Button, x574 y242 w234 h30 vSSOK_CalcCopyBtn gSSOK_CalcCopyResult, °á°ú º¹»ç
    ...
    Gui, SSOKCalc:Font, s11 bold c173F52, Malgun Gothic
    Gui, SSOKCalc:Add, Text, x12 y98 w796 h28 Hidden vSSOK_CareerTitle, °æ·Â±â°£
    Gui, SSOKCalc:Font, s9 bold c173F52, Malgun Gothic
    Gui, SSOKCalc:Add, GroupBox, x12 y126 w796 h700 Hidden vSSOK_CareerGroup, °æ·Â±â°£ ÀÔ·Â
    Gui, SSOKCalc:Add, Text, x20 y148 w62 h20 Center Hidden vSSOK_CareerHeadV, ¼±ÅÃ
    Gui, SSOKCalc:Add, Text, x84 y148 w30 h20 Center Hidden vSSOK_CareerHeadNo, ±¸ºÐ
    Gui, SSOKCalc:Add, Text, x120 y148 w150 h20 Center Hidden vSSOK_CareerHeadStart, ½ÃÀÛÀÏ
    Gui, SSOKCalc:Add, Text, x278 y148 w150 h20 Center Hidden vSSOK_CareerHeadEnd, Á¾·áÀÏ
    Gui, SSOKCalc:Add, Text, x436 y148 w130 h20 Center Hidden vSSOK_CareerHeadRate, ÀÎÁ¤·ü
    Gui, SSOKCalc:Add, Text, x570 y148 w225 h20 Center Hidden vSSOK_CareerHeadYMD, ÀÎÁ¤ °æ·Â (³â¡¤¿ù¡¤ÀÏ)
    ...
    Loop, 10
    {
        ...
        Gui, SSOKCalc:Add, CheckBox, x20 y%y% w62 h28 Center Hidden vSSOK_CareerUse%idx% gSSOK_CareerSelectionChanged %checkOpt%, ¼±ÅÃ
    ...
    Gui, SSOKCalc:Font, s9 bold c173F52, Malgun Gothic
    Gui, SSOKCalc:Add, Text, x22 y590 w110 h24 +0x200 Hidden vSSOK_CareerTotalLabel, ÃÑ ±Ù¹«³âÇÑ
    Gui, SSOKCalc:Add, Text, x135 y590 w250 h24 Center +0x200 Hidden vSSOK_CareerTotalYMD, 0³â 0¿ù 0ÀÏ
    Gui, SSOKCalc:Add, Text, x400 y590 w395 h24 Center +0x200 Hidden vSSOK_CareerTotalMonths, ÃÑ ÀÎÁ¤°³¿ù: 0°³¿ù
    Gui, SSOKCalc:Add, Text, x22 y620 w773 h24 Center +0x200 Hidden vSSOK_CareerTotalDays, ÃÑ 0ÀÏ (ÆòÀÏ 0ÀÏ / ÁÖ¸» 0ÀÏ) / ÀÎÁ¤ÀÏ¼ö 0ÀÏ
    ...
    Gui, SSOKCalc:Font, s8 norm c2A5C70, Malgun Gothic
    Gui, SSOKCalc:Add, Text, x22 y670 w773 h38 Left Hidden vSSOK_CareerHelp1, ¡Ø ¼±ÅÃ ¹öÆ°À» ´©¸¥ °æ·Â¸¸ °è»êÇÕ´Ï´Ù. ½ÃÀÛÀÏ°ú Á¾·áÀÏÀÌ °°À¸¸é 1ÀÏ·Î °è»êÇÕ´Ï´Ù.`n¡Ø ÀÎÁ¤·üÀº °æ·Âº°·Î ÀÔ·ÂÇÏ¸ç ±âº»°ªÀº 100ÀÔ´Ï´Ù.
    Gui, SSOKCalc:Add, Text, x22 y712 w773 h42 Left Hidden vSSOK_CareerHelp2, ¿¹½Ã: 1¹ø = ¿ÃÇØ 3¿ù 1ÀÏ ~ ´ÙÀ½ ÇØ 2¿ù ¸»ÀÏ / 2¹ø = ÀÛ³â 3¿ù 1ÀÏ ~ ¿ÃÇØ 2¿ù ¸»ÀÏ.`n¡Ø À±³âÀÇ 2¿ù ¸»ÀÏÀº 29ÀÏÀÌ¸ç, ¼±ÅÃµÈ ±â°£ÀÌ ¼­·Î °ãÄ¡¸é Áßº¹ ³¯Â¥´Â ÇÑ ¹ø¸¸ ÇÕ»êÇÕ´Ï´Ù.

    Gui, SSOKCalc:Add, Button, x22 y770 w773 h34 Hidden vSSOK_CareerCopyBtn gSSOK_CareerCopy, °æ·Â °á°ú º¹»ç
    Gui, SSOKCalc:Show, w820 h850, SSOK ÇàÁ¤¾÷¹« °£Æí °è»ê±â
...
SSOK_CalcApplyModeUI:
    ...
    {
        Gui, SSOKCalc:Show, w820 h850, SSOK ÇàÁ¤¾÷¹« °£Æí °è»ê±â - °æ·Â±â°£

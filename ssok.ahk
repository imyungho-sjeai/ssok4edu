...
SSOK_EDU_ShowOrgPicker(defaultOfficeCode := "", defaultSupport := "")
{
    ...
    Gui, SSOKEDUOrg:Add, Text, x12 y14 w48 h20 +0x200, ±³À°Ã»
    ...
    Gui, SSOKEDUOrg:Add, Text, x307 y14 w48 h20 +0x200, Áö¿øÃ»
    Gui, SSOKEDUOrg:Add, DropDownList, x357 y12 w270 h240 vSSOK_EDU_OrgSupport gSSOK_EDU_OrgSupportChanged, ±³À°Ã» ÀüÃ¼
    Gui, SSOKEDUOrg:Add, Text, x642 y14 w48 h20 +0x200, ÇÐ±³±Þ
    Gui, SSOKEDUOrg:Add, DropDownList, x692 y12 w120 h240 vSSOK_EDU_OrgKind gSSOK_EDU_OrgKindChanged, ÀüÃ¼
    Gui, SSOKEDUOrg:Font, s8 norm c4B5563, Malgun Gothic
    Gui, SSOKEDUOrg:Add, Text, x825 y14 w180 h20 vSSOK_EDU_OrgStatus +0x200, ÇÐ±³ ¸ñ·Ï ºÒ·¯¿À´Â Áß...
    Gui, SSOKEDUOrg:Font, s9 norm c222222, Malgun Gothic
    Gui, SSOKEDUOrg:Add, Button, x1098 y10 w92 h26 gSSOK_EDU_OrgExportExcel, ¿¢¼¿ ÀúÀå
    Gui, SSOKEDUOrg:Add, Button, x1196 y10 w100 h26 gSSOK_EDU_OrgSelectSchool Default, ÇÐ±³ ¿­±â

    Gui, SSOKEDUOrg:Add, ListView, x12 y45 w1284 h395 vSSOK_EDU_OrgSchoolList gSSOK_EDU_OrgSchoolListEvent AltSubmit, ÇÐ±³¸í|ÇÐ±³±Þ|ÇÐ±Þ¼ö|Áö¿øÃ»|ÁÖ¼Ò|ÀüÈ­|ÆÑ½º|È¨ÆäÀÌÁö|ÇÐ±³ÄÚµå
    Gui, SSOKEDUOrg:Show, w1308 h452, SSOK4edu °üÇÒ ±³À°Ã»
    SSOK_EDU_LoadOrgSchools()
}
...
SSOK_EDU_RefreshOrgSchoolList()
{
    ...
    if (IsObject(SSOK_EDU_OrgSchools))
    {
        ...
        {
            if (support != "" && support != "±³À°Ã» ÀüÃ¼" && item.parentOrg != support)
                continue

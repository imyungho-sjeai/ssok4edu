...
SSOK_AdminCalendar_ShowDatePopup(targetYmd := "", manual := false, autoHideMs := 0)
{
    ...
    ; ÇÑ È­¸é¿¡´Â ¼±ÅÃÇÑ ³¯Â¥ 1ÀÏÄ¡¸¸ Ç¥½Ã: ¼­¿ï / ÀüºÏ 2Ä­.
...
SSOK_AdminCalendar_ShowPopupColumns(title, seoulEvents, jeonbukEvents, schoolLine := "", mealLine := "", targetYmd := "", seoulError := "", jeonbukError := "", autoHideMs := 0)
{
    ...
    Gui, SSOKAdminCalPopup:Add, Button, x570 y36 w58 h25 gSSOK_AdminCalendar_DateToday, ¿À´Ã

    ; ¼±ÅÃÇÑ ³¯Â¥ÀÇ ¼­¿ï/ÀüºÏ ÀÏÁ¤Àº Ç×»ó 2Ä­¸¸ »ç¿ëÇÕ´Ï´Ù.
    ; ÇØ´ç Áö¿ª¿¡ Ç¥½ÃÇÒ ÀÏÁ¤(¶Ç´Â Á¶È¸ ¿À·ù)ÀÌ ÀÖÀ» ¶§¸¸ Áö¿ª¸íÀ» Ç¥½ÃÇÕ´Ï´Ù.
    Gui, SSOKAdminCalPopup:Font, s7 Bold c555555, Malgun Gothic
    if (Trim(seoulText) != "")
        Gui, SSOKAdminCalPopup:Add, Text, x24 y70 w435 h18 Left, ¼­¿ï
    if (Trim(jeonbukText) != "")
        Gui, SSOKAdminCalPopup:Add, Text, x505 y70 w435 h18 Left, ÀüºÏ
    ...
    ; ¼¼·Î ±¸ºÐ¼±Àº ¼­¿ï/ÀüºÏ ÀÏÁ¤ ¿µ¿ª±îÁö¸¸ Ç¥½ÃÇÕ´Ï´Ù.
    sepY := 68
    ...
    ; ¼­¿ï/ÀüºÏ ÇàÁ¤ÀÏÁ¤°ú ¿ì¸®ÇÐ±³ ÁÖ°£ÀÏÁ¤/±Þ½ÄÀ» °¡·Î¼±À¸·Î ±¸ºÐ

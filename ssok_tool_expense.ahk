...
; ============================================================================
; ¿¹»ê DashBoard - 1Â÷ ÀÔ·Â È­¸é
; - È¸°è ÀåÇ¥¸¦ Excel/K-¿¡µàÆÄÀÎ¿¡¼­ º¹»çÇÑ µÚ ±×´ë·Î ºÙ¿©³Ö´Â ´Ü°è
; - ºÐ¼®/Sorting/ÃßÃâ ±â´ÉÀº ÀÌ ¿øº» µ¥ÀÌÅÍ¸¦ ±âÁØÀ¸·Î ´ÙÀ½ ´Ü°è¿¡¼­ ¿¬°á
; ============================================================================
...
SSOK_Expense_BudgetDashboard_Paste:
    if (Clipboard = "")
    {
        MsgBox, 48, ¿¹»ê DashBoard, Å¬¸³º¸µå¿¡ ºÙ¿©³ÖÀ» ÀåÇ¥°¡ ¾ø½À´Ï´Ù.
        return
    }
    GuiControl, SSOKBudgetDashboard:, SSOK_BudgetDashboardRaw, %Clipboard%
    GuiControl, SSOKBudgetDashboard:, SSOK_BudgetDashboardStatus, È¸°è ÀåÇ¥¸¦ ºÙ¿©³Ö¾ú½À´Ï´Ù. OK¸¦ ´­·¯ ÀÔ·ÂÀ» È®ÀÎÇØ ÁÖ¼¼¿ä.
return
...
SSOK_Expense_BudgetDashboard_OK:
    ...
    if (raw = "")
    {
        MsgBox, 48, ¿¹»ê DashBoard, È¸°è ÀåÇ¥¸¦ ºÙ¿©³Ö¾î ÁÖ¼¼¿ä.
        return
    }
    ...
    status := "ÀÔ·Â ¿Ï·á: " . rowCount . "Çà"
    if (maxCols > 0)
        status .= " / ÃÖ´ë " . maxCols . "¿­"
    status .= "  ¡¤  ºÐ¼®/Sorting/ÃßÃâ¿ë ¿øº» ÀåÇ¥¸¦ º¸°üÇß½À´Ï´Ù."
...
SSOK_Expense_BudgetDashboard_Show()
{
    ...
    Gui, SSOKBudgetDashboard:Add, Text, x18 y14 w864 h30 c005BAC, ¿¹»ê DashBoard

    Gui, SSOKBudgetDashboard:Font, s9 Norm, Malgun Gothic
    Gui, SSOKBudgetDashboard:Add, Text, x18 y48 w864 h38 c555555, ¿¡µàÆÄÀÎ/ExcelÀÇ È¸°è ÀåÇ¥ ¿µ¿ªÀ» º¹»çÇÑ µÚ ¾Æ·¡ ÀÔ·ÂÃ¢¿¡ Ctrl+V·Î ºÙ¿©³Ö°Å³ª [È¸°è ÀåÇ¥ ºÙ¿©³Ö±â]¸¦ ´­·¯ ÁÖ¼¼¿ä.`nºÙ¿©³ÖÀº ¿øº»Àº ÀÌÈÄ ¿¹»ê ºÐ¼® ¡¤ Sorting ¡¤ Á¶°Çº° ÃßÃâ ±â´ÉÀÇ ±âÁØ µ¥ÀÌÅÍ·Î »ç¿ëÇÕ´Ï´Ù.

    Gui, SSOKBudgetDashboard:Font, s10 Bold, Malgun Gothic
    Gui, SSOKBudgetDashboard:Add, Button, x18 y94 w210 h36 gSSOK_Expense_BudgetDashboard_Paste, È¸°è ÀåÇ¥ ºÙ¿©³Ö±â
    ...
    Gui, SSOKBudgetDashboard:Add, Button, x18 y570 w120 h38 gSSOK_Expense_BudgetDashboard_Clear, ÃÊ±âÈ­
    Gui, SSOKBudgetDashboard:Add, Button, x148 yp w120 h38 gSSOK_Expense_BudgetDashboard_OK Default, OK

    Gui, SSOKBudgetDashboard:Show, w900 h628 Center, ¿¹»ê DashBoard
}

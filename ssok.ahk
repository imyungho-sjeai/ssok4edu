...
global SSOK_VERSION := "260914-C21"
global SSOK_VERSION_DATE := "2026.9.14"
...
SSOK_Sidebar_PCOff:
    ; PC OFF´Â Á÷Àü ÀÛ¾÷Ã¢À» ´Ù½Ã È°¼ºÈ­ÇÏÁö ¾Ê°í ¹Ù·Î ÀýÀü Ã³¸®
    Gosub, SSOK_DoMouseWakeSleep
return
...
SSOK_ShowQuickUrlMenu:
    ...
    Gui, SSOKQuickUrl:Add, Text, x20 y560 w150 h24 Center +0x200 gSSOK_QU_OpenSchoolSearchFromMenu, [¼¼Á¾ °ü³» ÇÐ±³]
    Gui, SSOKQuickUrl:Add, Text, x180 y560 w150 h24 Center +0x200 gSSOK_QU_OpenSchoolInfoFromMenu, [ÇÐ±³¾Ë¸®¹Ì1]
    Gui, SSOKQuickUrl:Add, Text, x340 y560 w150 h24 Center +0x200 gSSOK_QU_OpenSchoolInfo2FromMenu, [ÇÐ±³¾Ë¸®¹Ì2]
    Gui, SSOKQuickUrl:Add, Text, x500 y560 w150 h24 Center +0x200 gSSOK_QU_OpenLocalFinanceInfoFromMenu, [Áö¹æ±³À°ÀçÁ¤ ¾Ë¸®¹Ì]
    Gui, SSOKQuickUrl:Add, Text, x100 y588 w150 h24 Center +0x200 gSSOK_QU_OpenEduOfficeSearchFromMenu, [±³À°Ã» ¾÷¹«´ã´ç]
    Gui, SSOKQuickUrl:Add, Text, x265 y588 w150 h24 Center +0x200 gSSOK_QU_OpenSchoolSupportInfoFromMenu, [ÇÐ±³Áö¿øº»ºÎ ¾÷¹«¾È³»]
    Gui, SSOKQuickUrl:Add, Text, x430 y588 w150 h24 Center +0x200 gSSOK_QU_OpenContractInfoFromMenu, [°Å·¡Ã³ °è¾àÁ¤º¸]

    Gui, SSOKQuickUrl:Font, s8 norm, Malgun Gothic
    Gui, SSOKQuickUrl:Add, Text, x20 y620 w400 h18 c999999, ¼ýÀÚ 1~9¹øÅ° ¶Ç´Â [ÀúÀå&¿­±â]·Î ¹Ù·Î°¡±â
    Gui, SSOKQuickUrl:Add, Text, x350 y642 w290 h18 Right c999999, ÀúÀÛ±Ç: ¼¼Á¾Æ¯º°ÀÚÄ¡½Ã±³À°Ã» ÁÖ¹«°ü ÀÌ¸íÈ£
    SSOK_GetSidebarAttachedGuiPos(680, 670, SSOK_QU_WinX, SSOK_QU_WinY)
    Gui, SSOKQuickUrl:Show, x%SSOK_QU_WinX% y%SSOK_QU_WinY% w680 h670, SSOK ÀÚÁÖ°¡´Â »çÀÌÆ®
return

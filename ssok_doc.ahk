...
DOC_ShowTemplateGui()
{
    ...
    {
        MsgBox, 48, SSOK Help, ½ÇÁ¦ ÀÔ·Â °¡´ÉÇÑ °÷À» Å¬¸¯ÇÑ µÚ [°£´Ü ÀÛ¼º]À» ½ÇÇàÇØ ÁÖ¼¼¿ä.`n
        return
    }
    ...
    Gui, DOC:Add, Text, x20 y16 w920 h34 Center, ½î¿Á for K-¿¡µàÆÄÀÎ
    ...
    Gui, DOC:Add, Text, x20 y72 w170 h28 Center, ¹°Ç°
    Gui, DOC:Add, Text, x205 y72 w170 h28 Center, ¿ë¿ª
    Gui, DOC:Add, Text, x390 y72 w170 h28 Center, ±âÅ¸
    Gui, DOC:Add, Text, x575 y72 w170 h28 Center, ¼¼ÀÔ
    Gui, DOC:Add, Text, x760 y72 w170 h28 Center, ÀÏ¹Ý

    Gui, DOC:Font, s9 Bold c003D73, Malgun Gothic
    Gui, DOC:Add, Button, x20 y126 w170 h34 gGUI_GoodsGeneral, ÀÏ¹Ý¹°Ç°
    Gui, DOC:Add, Button, x20 y166 w170 h34 gGUI_Supplies, ÇÐ½ÀÁØºñ¹°
    Gui, DOC:Add, Button, x20 y206 w170 h34 gGUI_Book, µµ¼­
    Gui, DOC:Add, Button, x20 y246 w170 h34 gGUI_Album, Á¹¾÷¾Ù¹ü
    Gui, DOC:Add, Button, x20 y286 w170 h34 gGUI_CareSnack, µ¹º½±³½Ç °£½Ä
    Gui, DOC:Add, Button, x20 y326 w170 h34 gGUI_Furniture, ºñÇ°
    Gui, DOC:Add, Button, x20 y366 w170 h34 gGUI_OldGoodsImprove, ³ëÈÄÈ­ È¯°æ°³¼±
    Gui, DOC:Add, Button, x20 y406 w170 h34 gGUI_SchoolMeal, ÇÐ±³ ±Þ½Ä

    Gui, DOC:Font, s9 Bold c004D3B, Malgun Gothic
    Gui, DOC:Add, Button, x205 y126 w170 h34 gGUI_ServiceGeneral, ÀÏ¹Ý¿ë¿ª
    Gui, DOC:Add, Button, x205 y166 w170 h34 gGUI_FieldTripBus, ÇöÀåÃ¼Çè Â÷·®ÀÓÂ÷
    Gui, DOC:Add, Button, x205 y206 w170 h34 gGUI_SchoolTrip, ¼öÇÐ¿©Çà ¿ë¿ª
    Gui, DOC:Add, Button, x205 y246 w170 h34 gGUI_AfterSchool, ¹æ°úÈÄÇÐ±³ À§Å¹
    Gui, DOC:Add, Button, x205 y286 w170 h34 gGUI_SchoolBus, ÅëÇÐ¹ö½º ÀÓÂ÷
    Gui, DOC:Add, Button, x205 y326 w170 h34 gGUI_CleaningService, Ã»¼Ò¿ë¿ª

    Gui, DOC:Font, s9 Bold c423070, Malgun Gothic
    Gui, DOC:Add, Button, x390 y126 w170 h34 gGUI_MeetingFee, ÇùÀÇÈ¸ºñ
    Gui, DOC:Add, Button, x390 y166 w170 h34 gGUI_LecturerFee, °­»çºñ
    Gui, DOC:Add, Button, x390 y206 w170 h34 gGUI_TravelFee, ÃâÀåºñ

    ; ±âÅ¸¿Í °ø»ç »çÀÌ¸¦ ÇÑ ÁÙ ¶ç¿ö ±¸ºÐ
    Gui, DOC:Font, s9 Bold c5A3300, Malgun Gothic
    Gui, DOC:Add, Button, x390 y286 w170 h30 gGUI_OtherGift, »óÇ°±Ç
    Gui, DOC:Add, Button, x390 y326 w170 h30 gGUI_OtherCard, ¹ýÀÎÄ«µå»ç¿ëºÎ
    Gui, DOC:Add, Text, x390 y366 w170 h24 Center, °ø»ç
    Gui, DOC:Add, Button, x390 y406 w170 h30 gGUI_Construction, ÀÏ¹Ý°ø»ç
    Gui, DOC:Add, Text, x575 y370 w170 h24 Center, ¿¹»ê
    Gui, DOC:Add, Button, x575 y410 w170 h30 gGUI_Budget1, ¿¹»ê¿ä±¸¼­
    Gui, DOC:Add, Button, x575 y440 w170 h30 gGUI_Budget2, Ãß°¡°æÁ¤¿¹»ê
    Gui, DOC:Add, Button, x575 y470 w170 h30 gGUI_Budget3, ¼º¸³Àü(¸ñÀû»ç¾÷ºñ)
    Gui, DOC:Add, Button, x575 y500 w170 h30 gGUI_Budget4, ¼º¸³Àü(¼öÀÍÀÚºÎ´ã)
    Gui, DOC:Add, Button, x575 y530 w170 h30 gGUI_Budget5, °ú¸ñ°æÁ¤
    ...
    Gui, DOC:Font, s9 Bold c003D73, Malgun Gothic
    Gui, DOC:Add, Button, x760 y126 w170 h34 gGUI_GeneralPlan, °èÈ¹¼ö¸³
    Gui, DOC:Add, Button, x760 y166 w170 h34 gGUI_GeneralEventNotice, Çà»ç¾È³»

    Gui, DOC:Font, s9 Bold c423070, Malgun Gothic
    Gui, DOC:Add, Text, x760 y286 w170 h24 Center, ±âÅ¸
    Gui, DOC:Add, Button, x760 y326 w170 h34 gGUI_NationalPetition, ±¹¹Î½Å¹®°í
    Gui, DOC:Add, Button, x760 y366 w170 h34 gGUI_SchoolMarket, ÇÐ±³ÀåÅÍ
    Gui, DOC:Add, Button, x760 y406 w170 h34 gGUI_LegalBasis, ¹ý·É±Ù°Å

    ; ¿ÞÂÊ ÇÏ´Ü ¾È³»¹®
    Gui, DOC:Font, s7 c777777, Malgun Gothic
    Gui, DOC:Add, Text, x20 y570 w420 h18 Left, ½î¿Á for K-¿¡µàÆÄÀÎ (SSOK-Sejong Smart One Key)

    ; ¿À¸¥ÂÊ ÇÏ´Ü ÀúÀÛ±Ç
    Gui, DOC:Font, s7 c777777, Malgun Gothic
    Gui, DOC:Add, Text, x540 y570 w390 h18 Right, ÀúÀÛ±Ç: ¼¼Á¾Æ¯º°ÀÚÄ¡½Ã±³À°Ã» ÁÖ¹«°ü ÀÌ¸íÈ£

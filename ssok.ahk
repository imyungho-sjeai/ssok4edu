...
SSOK_EDU_ShowOrgPicker(defaultOfficeCode := "", defaultSupport := "")
{
    ...
    Gui, SSOKEDUOrg:Add, ListView, x12 y45 w1284 h395 vSSOK_EDU_OrgSchoolList gSSOK_EDU_OrgSchoolListEvent AltSubmit NoSortHdr, ÇÐ±³¸í|ÇÐ±³±Þ|±³À°Ã»|Áö¿øÃ»|ÁÖ¼Ò|ÀüÈ­|ÆÑ½º|È¨ÆäÀÌÁö
